...
var port_cutlet = {
  "title": "Pork cutlet",
    ...
    "tools":[],
    "main":[{"name": "Egg", "amount": 2, "unit": ""},
      {"name": "Port tenderloins", "amount": 2, "unit": "pieces"},
      {"name": "Flour", "amount": 2, "unit": "table spoons"},
      {"name": "butter", "amount": 2, "unit": "table spoons"},
      {"name": "Green onion", "amount": 1, "unit": "bunch"}],
    "sub":[{"name": "Onion", "amount": 1/2, "unit": ""},
      {"name": "Dill pickles", "amount": 1/3, "unit": "cup"},
      {"name": "Jalapeno pepper", "amount": 1, "unit": ""}],
    "steps": [{
          "step": 0,
...
var recipes = [carbonara, omelet_rice, port_cutlet];
